...
| FR-0401-CANCIONERO-017 | Filtros de moderación                           | `/moderacion` permite filtrar por pendiente, publicada, rechazada o todas, además de buscar por título/etiquetas y seleccionar tiempo y momento litúrgico                                                                                                                                                  |
| FR-0401-CANCIONERO-018 | Validación bilingüe de acordes                  | La contribución valida raíces anglosajonas y españolas, incluyendo calidades, alteraciones y bajos; conserva la nomenclatura ingresada                                                                                                                                                                     |
| FR-0401-CANCIONERO-019 | Herramientas de lectura                         | El detalle permite ajustar tamaño de letra, transportar acordes por semitonos y restablecer el tono original sin modificar la canción persistida                                                                                                                                                           |
| FR-0401-CANCIONERO-020 | Diagramas de acordes                            | El detalle muestra diagramas disponibles en tira y popup al seleccionar un acorde, con fallback visible cuando no existe una forma conocida                                                                                                                                                                |
