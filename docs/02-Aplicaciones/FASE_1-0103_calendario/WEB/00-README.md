...
- **Pendiente:** smoke/integration tests, hardening del build en Windows con adaptador Vercel y ampliación documental/operativa para próximos ciclos litúrgicos.
