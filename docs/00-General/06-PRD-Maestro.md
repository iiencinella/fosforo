...
| Fase 2 - Core de contenido   | Consolidar contenido religioso, experiencias guiadas y producto editorial conectado a la plataforma           | Misal, Oraciones, Santopedia, Vida de Misionero, Visita 7 Iglesias                                                                                                                                       | Contenido central reusable, dependencias de plataforma estabilizadas y experiencias conectadas acumuladas       |
