...
| ---------------------------- | ------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------- |
| Fase 1 - Nucleo funcional    | Construir la plataforma base y las apps iniciales que validan identidad, liturgia, contenido y observabilidad | Fósforo Portal, Biblia, Calendario Liturgico, Horarios de Misas, Sistema de Logueo, Gestion de Usuarios, Panel de Administración           | Plataforma base operativa, observabilidad minima y clientes iniciales funcionando sobre capacidades compartidas |
| Fase 2 - Core de contenido   | Consolidar contenido religioso, experiencias guiadas y producto editorial conectado a la plataforma           | Misal, Oraciones, Santopedia, Vida de Misionero, Visita 7 Iglesias, Espiritualidad diaria, Sistema de Notificaciónes, CMS, Motor liturgico | Contenido central reusable, dependencias de plataforma estabilizadas y experiencias conectadas acumuladas       |
...
- Reclasificación (2026-08-25): Espiritualidad diaria, Sistema de Notificaciónes, CMS y Motor Liturgico se mueven de Fase 1 a Fase 2. En Fase 1 estos modulos no tenian documentación ni implementación; su dependencia real aparece con los clientes editoriales de Fase 2 (Misal, Oraciones, etc.). El núcleo litúrgico que Fase 1 necesita queda cubierto por la app Calendario Liturgico.
